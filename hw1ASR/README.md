...
Despite already numerous ASR HW's available on the internet (they are different though) and research and production implementations, the goal is to make you capable to create your own device. Once more, we have the means and we literally check it. 

**This instruction is important**, even though it is quite large, if you stick to it and course materials together with research papers, you will succeed.
...
You could submit your solution after soft deadline. You are charged `(-k)` point for submitting on the k-th day after the soft deadline.

There is strict deadline after the soft one. After it, submissions are closed.
...
> [!NOTE]
> This year, we allow you to do any of the 3 model types.
