...
- [Creating convenient DL pipelines and clean code](https://youtu.be/PE1zaW5it_A)
- [Experiment Tracking (logging)](https://youtu.be/sEA-Js5ZHxU)
- [Git, Python-Dev-Tips](https://youtu.be/okxaTuBdDuY)

Additional Materials:

- [Python Dev Tips](https://github.com/ebezzam/python-dev-tips): Tips on Python development (Lecture Recording can be found [here](https://youtu.be/UG3pqCps2Ws)).
- [Collaborative Coding with GitHub](https://github.com/ebezzam/python-dev-tips): Introduction to Git (Lecture Recording can be found [here](https://youtu.be/3PIcBzBj5jY)).
- [CLAIRE Template for Reproducible Projects](https://github.com/CLAIRE-Labo/python-ml-research-template): another template, more focused on Docker-based reproducibility rather than code-style and formatting.
